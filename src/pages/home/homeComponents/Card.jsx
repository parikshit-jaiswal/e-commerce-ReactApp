...
function Card({ p_id, name, originalPrice, discountPercent, priceAfterDiscount, imageUrl, del = false, addToCart }) {
    return (
        <div className='cardBox min-w-[20rem] h-[22rem] rounded-lg cursor-pointer' style={{ boxShadow: "rgba(0, 0, 0, 0.05) 0px 0px 0px 1px" }}>
            <div className="card ">
                ...
                <div className="bg-black text-center items-center p-2  rounded-b-lg">
                    <span role='button' onClick={() => addToCart(p_id)} className='text-white hover:text-[#DB4444]'><i className="fa-solid fa-cart-shopping"></i>Add to Cart</span>
                </div>
                <div className="relative bottom-[15.7rem] left-3 flex justify-between items-center">
                    ...
                    <span className="likeBtn mr-6  bg-white h-8 w-8 flex justify-center items-center rounded-full">
                        {del ? <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z" /></svg> : <i className="fa-regular fa-heart mt-[0.1rem] text-xl"></i>}
                    </span>
                </div>
            </div>
